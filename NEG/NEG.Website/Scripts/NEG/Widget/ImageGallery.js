NEG.Module("NEG.Widget.ImageGallery", function (require) {
    ...
    var ImageListView = function (config, option, eventObj) {
        ...
        for (var i = 0; i < flist.length; i++) {
            ...
            temp.hover(function () {
                selectedIndex == NEG.utility.Array.indexOf(objList.domList, this) || jq(this).css({
                    border: '1px solid black'
                });
            }, function () {
                jq(this).css({
                    border: selectedIndex == NEG.utility.Array.indexOf(objList.domList, this) ? '1px solid blue' : '1px solid #ccc'
                });
            });
            temp.click(function () {
                resetSelected();
                setSelected(this);
                selectedIndex = NEG.utility.Array.indexOf(objList.domList, this);
                var selectedConfig = flist[selectedIndex];
                var index = NEG.utility.Array.indexOf(objList.domList, this);
