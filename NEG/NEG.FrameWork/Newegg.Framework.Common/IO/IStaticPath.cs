namespace Newegg.Framework.IO
{
    ...
    /// </summary>
    internal interface IStaticPath
    {
        /// <summary>
        ...
        /// <exception cref="System.ArgumentException">The path parameter contains invalid characters, is empty, or contains only white spaces.</exception>
        ...
        /// <exception cref="System.ArgumentException">Path is a zero-length string, contains only white space, or contains one or more of the invalid characters defined in System.IO.Path.GetInvalidPathChars().-or- The system could not retrieve the absolute path.</exception>
